		...
		<div class="container">
			...
			<div class="collapse navbar-collapse navbar-right navbar-ex1-collapse">
				<ul class="nav navbar-nav">
					<li class="menuItem"><a href="coleccion.html">Colecciones</a></li>
					<li class="menuItem"><a href="proceso.html">Proceso</a></li>
...
<!-- 					<input type="submit" name="submit" id="submit" value="Submit" class="btn wow tada btn-embossed btn-primary pull-right"> -->
					<button id="send" class="btn wow tada btn-embossed btn-primary pull-right"> Send</button>
				</div>
			</form>
	...
	<script type="text/javascript">
	  jQuery(function($) {
		...
		$("#send").click(function(){
			...
			var destino = $("#InputEmail").val();
			var msj = $("#InputMessage").val();
	        $.ajax({
		        url:'./php/controlador/contacto.php',
		        type:'POST',
		        data:'enviar=true&title='+title+'&destino='+destino+'&msj='+msj,
		        dataType: 'html',
